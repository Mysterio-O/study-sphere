                ...
                {mockPlans.map(plan => {
                    ...
                    return (
                        <motion.div
                            ...
                            className={`p-4 rounded-lg shadow-sm flex justify-between items-center ${style.bg} h-40`}
                        >
                            <div>
                                <h3 className="font-semibold text-[#202124] dark:text-[#F9FAFB]">
                                ...
                                <p className="text-sm mt-1 text-[#5F6368] dark:text-[#D1D5DB]">
