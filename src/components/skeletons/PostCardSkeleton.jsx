            ...
            <div className="px-10 flex flex-col gap-6">
                {Array.from({ length: count }).map((_, index) => (
                    ...
                    >
                        ...
                        <div className="shimmer-overlay absolute inset-0 transform -translate-x-full animate-pulse">
                        ...
                        {/* Actions Skeleton */}
                        <div className="flex justify-around border-t border-gray-200 dark:border-gray-700 pt-3 animate-pulse">
